...
Does nothing if no override is set.
    ...
    /**
     * Start using the given display features to populate the Viewport Segments API.
This override can also be set in setDeviceMetricsOverride().
     */
...
Bluetooth Core Specification Vol 2 Part D 1.3 List Of Error Codes.
    ...
    /**
     * Removes the service represented by |serviceId| from the peripheral with
|address|.
     */
...
service represented by |serviceId| in the peripheral with |address|.
    ...
    /**
     * Removes the characteristic represented by |characteristicId| from the
service represented by |serviceId| in the peripheral with |address|.
     */
