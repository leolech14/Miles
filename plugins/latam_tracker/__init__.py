...
class LatamTrackerPlugin:
    """Monitor LATAM Pass program for transfer bonuses."""
    ...
    def __init__(self) -> None:
        ...
        self.sources = [
            "https://www.latampass.latam.com/br/promocoes",
            "https://melhoresdestinos.com.br/tag/latam/",
            "https://passageirodeprimeira.com/tag/latam-pass/",
    ...
    def scrape(self, since: datetime) -> List[Promo]:
        ...
        for source_url in self.sources:
            try:
                ...
                if content:
                    source_promos = self._parse_latam_content(content, source_url)
        ...
        for pattern in patterns:
            ...
            for match in matches:
                try:
                    ...
                    if (
                        bonus_pct >= 40 and bonus_pct not in found_bonuses
                    ):  # LATAM threshold
    ...
    def _clean_title(self, context: str, bonus_pct: int) -> str:
        ...
        for sentence in sentences:
            if str(bonus_pct) in sentence and "latam" in sentence.lower():
                title = sentence.strip()
                if len(title) > 10:
                    return f"🛫 {title[:100]}..."

        # Fallback title
        return f"🛫 LATAM Pass {bonus_pct}% transfer bonus detected"
